...
const HEADER_COPY = {
  ...
  vi: {
    ...
    allRcCar: "T\u1ea5t c\u1ea3 RC Car",
    about: "Gi\u1edbi thi\u1ec7u",
    trackOrder: "Theo d\u00f5i \u0111\u01a1n h\u00e0ng",
    searchToys: "T\u00ecm \u0111\u1ed3 ch\u01a1i...",
  },
};
...
export default function Header() {
  ...
  const copy = HEADER_COPY[settings.shopping.language];
    ...
    <header className="sticky top-0 z-50 flex items-center justify-between px-8 py-4 w-full max-w-none bg-[#06151a]/80 backdrop-blur-xl border-b border-[#6FF7E8]/10 shadow-[0_0_20px_rgba(111,247,232,0.05)] font-['Plus_Jakarta_Sans'] tracking-tight">
      <div className="flex items-center gap-12">
        ...
        <nav className="hidden md:flex items-center gap-8">
              ...
              <div className="bg-[#0a1f26]/95 border border-[#6FF7E8]/30 rounded-xl shadow-[0_4px_30px_rgba(0,0,0,0.8)] p-6 backdrop-blur-xl grid grid-cols-3 gap-6">
                ...
                <div className="flex flex-col gap-2">
                  <div className="flex items-center gap-2 mb-2 border-b border-[#6FF7E8]/20 pb-2">
                    <span className="material-symbols-outlined text-[#6FF7E8] text-[18px]">
                      smart_toy
                    </span>
                    <span className="text-sm uppercase text-[#6FF7E8] font-bold">
                      Gundam
                    </span>
                  </div>
                  <Link
                    href="/shop?category=gundam-1-48"
                    className="text-sm text-[#EAFAF8]/80 hover:text-[#6FF7E8] hover:bg-[#6FF7E8]/10 px-2 py-1 -ml-2 rounded-md transition-colors font-medium"
                  >
                    {copy.gundamScale148}
                  </Link>
                  <Link
                    href="/shop?category=gundam-1-144"
                    className="text-sm text-[#EAFAF8]/80 hover:text-[#6FF7E8] hover:bg-[#6FF7E8]/10 px-2 py-1 -ml-2 rounded-md transition-colors font-medium"
                  >
                    {copy.gundamScale1144}
                  </Link>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <Link
                    href="/shop?category=one-piece-figure"
                    className="text-sm text-[#EAFAF8]/80 hover:text-[#6FF7E8] hover:bg-[#6FF7E8]/10 px-2 py-1 -ml-2 rounded-md transition-colors font-medium"
                  >
                    Figure One Piece
                  </Link>
                  <Link
                    href="/shop?category=one-piece-3d-lamps"
                    className="text-sm text-[#EAFAF8]/80 hover:text-[#6FF7E8] hover:bg-[#6FF7E8]/10 px-2 py-1 -ml-2 rounded-md transition-colors font-medium"
                  >
                    One Piece 3D Lamps
                  </Link>
                  <Link
                    href="/shop?category=one-piece-wall-arts"
                    className="text-sm text-[#EAFAF8]/80 hover:text-[#6FF7E8] hover:bg-[#6FF7E8]/10 px-2 py-1 -ml-2 rounded-md transition-colors font-medium"
                  >
                    One Piece Wall Arts
                  </Link>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <Link
                    href="/shop?category=lego-super-car"
                    className="text-sm text-[#EAFAF8]/80 hover:text-[#6FF7E8] hover:bg-[#6FF7E8]/10 px-2 py-1 -ml-2 rounded-md transition-colors font-medium"
                  >
                    Lego Super Car
                  </Link>
                  <Link
                    href="/shop?category=lego-ninjago"
                    className="text-sm text-[#EAFAF8]/80 hover:text-[#6FF7E8] hover:bg-[#6FF7E8]/10 px-2 py-1 -ml-2 rounded-md transition-colors font-medium"
                  >
                    Lego Ninja Go
                  </Link>
                  <Link
                    href="/shop?category=lego-harry-potter"
                    className="text-sm text-[#EAFAF8]/80 hover:text-[#6FF7E8] hover:bg-[#6FF7E8]/10 px-2 py-1 -ml-2 rounded-md transition-colors font-medium"
                  >
                    Lego Harry Potter
                  </Link>
          ...
          <Link className={getLinkClasses("/account/orders")} href="/account/orders">
            {copy.trackOrder}
          </Link>
        </nav>
      </div>
      <div className="flex items-center gap-6">
        <Suspense
          fallback={
            <div className="relative hidden lg:block">
              <input
                className="bg-[#0a1f26]/50 border border-[#6FF7E8]/20 rounded-xl pl-10 pr-4 py-2 w-64 text-sm transition-all text-[#EAFAF8] placeholder:text-[#EAFAF8]/30"
                placeholder={copy.searchToys}
                type="text"
                disabled
              />
              <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-[#6FF7E8]/40 text-lg">
                search
              </span>
            </div>
          }
        >
          <ProductSearchForm
            ...
            placeholderEn={HEADER_COPY.en.searchToys}
            placeholderVi={HEADER_COPY.vi.searchToys}
          />
        </Suspense>
